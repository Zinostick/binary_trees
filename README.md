...
Project done to learn what a binary tree is, the different methods to go through a binary tree and the different types of binary trees.

##Technologies
* Scripts written in Bash 4.4.12
* C files are compiled using `gcc 7.4.0
